...
import 'package:hotelbooking/modules/hotel_detailes/review_data_view.dart';
...
class HotelDetailes extends StatefulWidget {
  ...
  const HotelDetailes({super.key, required this.hotelData});
  @override
  HotelDetailesState createState() => HotelDetailesState();
}

class HotelDetailesState extends State<HotelDetailes>
              ...
              child: Row(
                children: <Widget>[
                  _getAppBarUi(
                    Theme.of(
                      context,
                    ).disabledColor.withAlpha((0.4 * 255).toInt()),
                    Icons.arrow_back,
                    ...
                    style: TextStyles(context).getRegularStyle().copyWith(
                      ...
                      color:
                          isInList
                              ? Theme.of(
                                context,
                              ).disabledColor.withAlpha((0.5 * 255).toInt())
                              : Colors.white,
                    ),
                  ),
                  SizedBox(width: 4),
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          ...
                          style: TextStyles(context).getRegularStyle().copyWith(
                            ...
                            color:
                                isInList
                                    ? Theme.of(context).disabledColor.withAlpha(
                                      (0.5 * 255).toInt(),
                                    )
                                    : Colors.white,
                          ),
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyles(context).getRegularStyle().copyWith(
                fontSize: 14,
                color:
                    isInList ? Theme.of(context).disabledColor : Colors.white,
              ),
            ),
          ],
        ),
