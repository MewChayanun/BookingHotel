...
import 'package:hotelbooking/modules/hotel_detailes/search_type_list.dart';
import 'package:hotelbooking/modules/hotel_detailes/search_view.dart';
...
class SearchScreenState extends State<SearchScreen>
  ...
  List<Widget> getPList(String serachValue) {
    ...
    var cout = 0;
    final columCount = 2;
    List<HotelListData> custList =
        lastsSearchesList
            .where(
              (element) => element.titleTxt.toLowerCase().contains(
