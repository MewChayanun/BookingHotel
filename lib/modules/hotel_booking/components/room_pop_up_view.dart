...
class RoomPopupView extends StatefulWidget {
  ...
  @override
  RoomPopupViewState createState() => RoomPopupViewState();
}

class RoomPopupViewState extends State<RoomPopupView>
      ...
      child: Scaffold(
        backgroundColor:
            appTheme.isLightMode
                ...
                : Theme.of(
                  context,
                ).colorScheme.surface.withValues(alpha: (0.6 * 255).toDouble()),
