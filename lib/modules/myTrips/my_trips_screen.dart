...
import 'package:hotelbooking/modules/myTrips/favorites_list_view.dart';
import 'package:hotelbooking/modules/myTrips/finish_trip_view.dart';
...
class MyTripsScreenState extends State<MyTripsScreen>
  ...
  void initState() {
    ...
    indexView = FinishTripView(animationController: tabAnimationController);
